...
export const getAll = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "lấy sản phẩm thành công ", data: data });
  } catch (error) {
...
export const create = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Thêm sản phẩm thành công ", data: data });
  } catch (error) {
    return res.status(500).json({ message: "Lỗi server: " + error.message });
  }
};
...
export const remove = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Xóa sản phẩm thành công ", data: data });
  } catch (error) {
    return res.status(500).json({ message: "Lỗi server: " + error.message });
  }
};
...
export const update = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Cập nhật sản phẩm thành công ", data: data });
  } catch (error) {
    return res.status(500).json({ message: "Lỗi server: " + error.message });
  }
};
